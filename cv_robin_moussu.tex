...
\hspace{1.5cm} \fr{Je viens de terminer ma formation d'ingénieur en informatique, et je suis actuellement à la recherche d'un emploi. Je suis tout particulièrement intéressé par l'informatique bas-niveau (notamment l'analyse de la mémoire), et par l'optimisation (en mémoire et en vitesse).}
\en{I just graduated from Grenoble INP, a computer science engineering school, and I am currently searching for a job. I am especially interested in algorithmic and I would like to used all the competences I learned during my schooling, thus working on low-level simulation motivates me.}
...
\cvitem{\fr{Outils}\en{Utils}}{\xx{git}, gcc, clang, Doxygen, \textbf{KiCad}, Lt Spice} 
...
\cventry{\fr{Robotique}\en{Robotics}}{\fr{Coupe de France de Robotique}\en{French cup of Robotics}}{
  \fr{
...
\cvitemwithcomment{}{\fr{Coupe inter-IUT à Vierzon, IUT GEII de Grenoble, 2012, demi-finale}\en{inter-IUT cups at Vierzon, IUT GEII of Grenoble, 2012, semi-final}}{}
