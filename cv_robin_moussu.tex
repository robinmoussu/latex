...
\en{Curious, ready to push changes, autonomous and volunteer, I am someone who love learning and know how to invest myself (especially in mastering my tools). High performance back-ends development, algorithms and optimizations are subjects that I love the most in my work. Since a bit more than two years, I discovered myself a passion for Rust and I had the chance to use it professionally. It's a technology that I'd like to use again in the future.}
