...
\hspace{1.5cm}
  \fr{Je viens de terminer ma formation d'ingénieur en informatique, et je suis actuellement à la recherche d'un emploi. Je suis particulièrement intéressé par l'algorithmie. Le travail d'équipe ainsi que la qualitée logicielle sont des valeurs importantes pour moi.}
  \en{I just graduated from Grenoble INP, a computer science engineering school, and I am currently searching for a job. I am especially interested in algorithmic, thus working on algorithms optimisation motivates me. I valuate highly software quality and teamwork.}

\vspace{\fill}

\section{\fr{Compétences}\en{Competences}}

\cvitem{\fr{Langages}\en{Languages}}{\xx{\cpp} (\fr{mon langage de prédilection}\en{my favorite language}), \xx{C}, \xx{ruby}, ada, sml, asm, vhdl}
\cvitem{\fr{Outils}\en{Utils}}{\xx{git} (\fr{usage quotidien}\en{daily use}), gcc, clang, Doxygen} 
